...
int main(int argc, char **argv) {
  ...
  ROS_INFO("Sucessfull complete configuratuion");
  ...
  auto batch_and_publish = OS1::batch_to_iter<CloudOS1::iterator>(
      xyz_lut, W, H, {}, &PointOS1::make, [&](uint64_t scan_ts) mutable {
  ...
  // ToDo:
  //  - Add variables for topics and give error message if default is used
